...
const (
	...
	GreetService_GetError_FullMethodName       = "/greet.GreetService/GetError"
)
...
type GreetServiceClient interface {
	...
	GetError(ctx context.Context, in *GreetErrorRequest, opts ...grpc.CallOption) (*GreetErrorResponse, error)
}
...
func (c *greetServiceClient) GetError(ctx context.Context, in *GreetErrorRequest, opts ...grpc.CallOption) (*GreetErrorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GreetErrorResponse)
	err := c.cc.Invoke(ctx, GreetService_GetError_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	// Error demonstration RPC: request a specific error type
	GetError(context.Context, *GreetErrorRequest) (*GreetErrorResponse, error)
...
func (UnimplementedGreetServiceServer) GetError(context.Context, *GreetErrorRequest) (*GreetErrorResponse, error) {
...
func _GreetService_GetError_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetErrorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).GetError(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GreetService_GetError_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GetError(ctx, req.(*GreetErrorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetError",
			Handler:    _GreetService_GetError_Handler,
		},
	},
