...
type GreetManyTimesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Count         int32                  `protobuf:"varint,2,opt,name=count,proto3" json:"count,omitempty"` // How many greetings to send
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_greet_proto_rawDesc = "" +
	...
	"\x0eGreetManyTimes\x12\x1c.greet.GreetManyTimesRequest\x1a\x1d.greet.GreetManyTimesResponse0\x01B:Z8grpc-learning/stage-08-first-streaming-proto/gen;greetpbb\x06proto3"
...
var file_greet_proto_depIdxs = []int32{
	...
	3, // 3: greet.GreetService.GreetManyTimes:output_type -> greet.GreetManyTimesResponse
