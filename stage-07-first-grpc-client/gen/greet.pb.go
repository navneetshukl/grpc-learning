// proto/greet.proto
// This is the contract between the gRPC client and server.
// Both sides generate their code from this single file.
...
const file_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x122\n" +
	"\x05Greet\x12\x13.greet.GreetRequest\x1a\x14.greet.GreetResponseB6Z4grpc-learning/stage-07-first-grpc-client/gen;greetpbb\x06proto3"
